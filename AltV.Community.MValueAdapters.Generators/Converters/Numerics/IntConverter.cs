...
internal class IntConverter : BaseConverter
{
    ...
    {
        stringBuilder.AppendLine(indentation, $"c.{propertyInfo.Name} = (int)reader.NextDouble();");
    }
    ...
    {
        stringBuilder.AppendLine(indentation, $"{propertyInfo.Name}Builder.Add((int)reader.NextDouble());");
    }
}
