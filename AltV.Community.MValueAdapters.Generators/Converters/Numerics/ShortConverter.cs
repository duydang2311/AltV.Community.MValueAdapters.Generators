...
internal class ShortConverter : BaseConverter
{
    ...
    {
        stringBuilder.AppendLine(indentation, $"c.{propertyInfo.Name} = (short)reader.NextDouble();");
    }
    ...
    {
        stringBuilder.AppendLine(indentation, $"{propertyInfo.Name}Builder.Add((short)reader.NextDouble());");
    }
}
