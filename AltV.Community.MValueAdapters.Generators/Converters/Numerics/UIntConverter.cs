...
internal class UIntConverter : BaseConverter
{
    ...
    {
        stringBuilder.AppendLine(indentation, $"c.{propertyInfo.Name} = (uint)reader.NextDouble();");
    }
    ...
    {
        stringBuilder.AppendLine(indentation, $"{propertyInfo.Name}Builder.Add((uint)reader.NextDouble());");
    }
}
